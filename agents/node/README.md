# node Directory Guide | agents/node 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `cy-node-agent/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
...
| 条目 | 职责 |
| --- | --- |
| `cy-node-agent/` | 嵌套源码或契约边界，下一步阅读其 README。 |
