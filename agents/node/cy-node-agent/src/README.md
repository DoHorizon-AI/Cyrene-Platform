# src Directory Guide | agents/node/cy-node-agent/src 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `bridge.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
| `upgrade.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# agents/node/cy-node-agent/src 目录指南
