# bootstrap Directory Guide | framework/jvm/bootstrap/src/main/kotlin/cyrene/bootstrap 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `CyreneControlPlaneApplication.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
