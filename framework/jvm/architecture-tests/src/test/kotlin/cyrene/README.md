# cyrene Directory Guide | framework/jvm/architecture-tests/src/test/kotlin/cyrene 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `arch/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
