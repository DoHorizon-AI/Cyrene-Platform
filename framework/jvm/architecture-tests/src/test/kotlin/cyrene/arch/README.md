# arch Directory Guide | framework/jvm/architecture-tests/src/test/kotlin/cyrene/arch 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `HexagonalArchitectureTest.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
