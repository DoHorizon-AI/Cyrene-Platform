# service Directory Guide | framework/jvm/application/src/test/kotlin/cyrene/application/service 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `ProductReconcilerTest.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
