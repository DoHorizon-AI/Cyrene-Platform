# inbound Directory Guide | framework/jvm/application/src/main/kotlin/cyrene/application/port/inbound 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `NodeRegistrationUseCase.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
