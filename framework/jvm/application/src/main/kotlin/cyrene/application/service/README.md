# service Directory Guide | framework/jvm/application/src/main/kotlin/cyrene/application/service 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `ProductReconciler.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
