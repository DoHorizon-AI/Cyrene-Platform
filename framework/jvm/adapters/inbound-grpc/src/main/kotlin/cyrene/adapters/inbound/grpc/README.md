# grpc Directory Guide | framework/jvm/adapters/inbound-grpc/src/main/kotlin/cyrene/adapters/inbound/grpc 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `NodeControlGrpcServer.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `NodeControlService.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
