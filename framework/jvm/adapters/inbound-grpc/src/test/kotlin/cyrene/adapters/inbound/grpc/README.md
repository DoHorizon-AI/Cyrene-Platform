# grpc Directory Guide | framework/jvm/adapters/inbound-grpc/src/test/kotlin/cyrene/adapters/inbound/grpc 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `NodeControlServiceTest.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
