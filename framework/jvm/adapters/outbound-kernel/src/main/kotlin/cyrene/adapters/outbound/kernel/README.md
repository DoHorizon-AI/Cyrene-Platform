# kernel Directory Guide | framework/jvm/adapters/outbound-kernel/src/main/kotlin/cyrene/adapters/outbound/kernel 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `KernelOutboundAdapter.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `NodeAgentGrpcClient.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
