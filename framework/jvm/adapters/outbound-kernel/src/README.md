# src Directory Guide | framework/jvm/adapters/outbound-kernel/src 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `main/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
| `test/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
