# outbound Directory Guide | framework/jvm/adapters/outbound-kernel/src/test/kotlin/cyrene/adapters/outbound 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `kernel/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
