# kernel Directory Guide | framework/jvm/adapters/outbound-kernel/src/test/kotlin/cyrene/adapters/outbound/kernel 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `NodeAgentGrpcClientTest.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
