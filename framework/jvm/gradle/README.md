# gradle Directory Guide | framework/jvm/gradle 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `gradle-daemon-jvm.properties` | Supporting metadata or fixture. | 辅助元数据或 fixture。 |
| `wrapper/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
