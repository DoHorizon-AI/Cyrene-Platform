# control Directory Guide | framework/jvm/domain/src/test/kotlin/cyrene/domain/control 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `ControlPlaneConformanceTest.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
