# control Directory Guide | framework/jvm/domain/src/main/kotlin/cyrene/domain/control 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `CanonicalSerialization.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `ExecutionPlan.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `ProductRun.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
