# model Directory Guide | framework/jvm/domain/src/main/kotlin/cyrene/domain/model 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `Lease.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `Node.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
| `WorkerInstance.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
