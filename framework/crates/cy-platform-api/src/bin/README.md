# bin Directory Guide | framework/crates/cy-platform-api/src/bin 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `cyrene-capability-resolver.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
