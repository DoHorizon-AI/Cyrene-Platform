# src Directory Guide | framework/crates/cy-extension-registry/src 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `helper.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
| `proxies/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
