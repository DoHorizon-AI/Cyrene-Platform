...
hex so they can be consumed by Rust, Kotlin, Python, and TypeScript without a
platform-specific binary file reader. `manifest.json` records the SHA-256 of
each wire value and the Core v1 descriptor digest used to produce it.
