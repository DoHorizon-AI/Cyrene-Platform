# manifest Directory Guide | contracts/rust/cy-manifest/src/manifest 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `artifact.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `hardware.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `mod.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `model.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
| `training.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
