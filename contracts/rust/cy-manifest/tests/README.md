# tests Directory Guide | contracts/rust/cy-manifest/tests 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `schema_validation.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# contracts/rust/cy-manifest/tests 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `schema_validation.rs` | Rust 实现、契约或测试文件。 |
