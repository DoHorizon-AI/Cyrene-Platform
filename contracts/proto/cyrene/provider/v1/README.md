# v1 Directory Guide | contracts/proto/cyrene/provider/v1 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `kernel_provider.proto` | Versioned Protobuf wire contract. | 版本化 Protobuf 线协议契约。 |
...
# contracts/proto/cyrene/provider/v1 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `kernel_provider.proto` | 版本化 Protobuf 线协议契约。 |
