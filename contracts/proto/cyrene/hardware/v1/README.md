# v1 Directory Guide | contracts/proto/cyrene/hardware/v1 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `hardware_adapter.proto` | Versioned Protobuf wire contract. | 版本化 Protobuf 线协议契约。 |
...
# contracts/proto/cyrene/hardware/v1 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `hardware_adapter.proto` | 版本化 Protobuf 线协议契约。 |
