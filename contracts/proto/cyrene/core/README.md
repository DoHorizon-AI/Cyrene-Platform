# core Directory Guide | contracts/proto/cyrene/core 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `v1/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
| `v2/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
...
# contracts/proto/cyrene/core 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `v1/` | 嵌套源码或契约边界，下一步阅读其 README。 |
| `v2/` | 嵌套源码或契约边界，下一步阅读其 README。 |
