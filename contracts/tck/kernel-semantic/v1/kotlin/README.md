# kotlin Directory Guide | contracts/tck/kernel-semantic/v1/kotlin 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `KernelSemanticTck.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
...
# contracts/tck/kernel-semantic/v1/kotlin 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `KernelSemanticTck.kt` | Kotlin Framework 实现或测试。 |
