# python Directory Guide | contracts/tck/astrbot-capability-worker/v1/python 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `astrbot_capability_worker_tck.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
