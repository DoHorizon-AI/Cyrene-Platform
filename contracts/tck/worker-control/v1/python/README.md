# python Directory Guide | contracts/tck/worker-control/v1/python 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `worker_control_tck.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
...
# contracts/tck/worker-control/v1/python 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `worker_control_tck.py` | Python SDK、TCK 或测试模块。 |
