# kotlin Directory Guide | contracts/tck/worker-control/v1/kotlin 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `WorkerControlTck.kt` | Kotlin Framework implementation or test. | Kotlin Framework 实现或测试。 |
...
# contracts/tck/worker-control/v1/kotlin 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `WorkerControlTck.kt` | Kotlin Framework 实现或测试。 |
