# src Directory Guide | runtime/cyrene-kernel/src 目录指南
...
| `runtime_journal.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# runtime/cyrene-kernel/src 目录指南
...
| `runtime_journal.rs` | Rust 实现、契约或测试文件。 |
