# tests Directory Guide | runtime/cyrene-kernel/tests 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `hardware_adapter_integration.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `sandbox_peer_credentials_linux.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# runtime/cyrene-kernel/tests 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `hardware_adapter_integration.rs` | Rust 实现、契约或测试文件。 |
| `sandbox_peer_credentials_linux.rs` | Rust 实现、契约或测试文件。 |
