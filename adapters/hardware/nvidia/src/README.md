# src Directory Guide | adapters/hardware/nvidia/src 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `discovery.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# adapters/hardware/nvidia/src 目录指南
