// ╔══════════════════════════════════════════════════════════════════════╗
// ║ 📄 File: adapters/hardware/linux_sys/src/lib.rs
...
// ║ 职责：Rust 实现、协议或一致性测试。
// ╚══════════════════════════════════════════════════════════════════════╝
//! CYRENE Linux System Adapter Host.
//!
//! Provides host CPU, memory, NUMA, and OS capability facts over versioned UDS protocol.
...
pub use probe::{parse_cpuinfo, parse_meminfo, LinuxSystemProvider, ParsedCpuInfo, ParsedMemInfo};
...
/// Handle one bounded local-adapter request over UDS.
#[allow(deprecated)]
                ...
                Ok(inventory) => hardware_v1::AdapterResponse {
                    ...
                    body: Some(hardware_v1::adapter_response::Body::Inventory(
                        hardware_v1::HardwareInventory {
                            ...
                            expires_at: Some(timestamp_after(Duration::from_secs(30))),
