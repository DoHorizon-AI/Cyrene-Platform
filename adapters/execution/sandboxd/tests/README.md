# tests Directory Guide | adapters/execution/sandboxd/tests 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `integration.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# adapters/execution/sandboxd/tests 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `integration.rs` | Rust 实现、契约或测试文件。 |
