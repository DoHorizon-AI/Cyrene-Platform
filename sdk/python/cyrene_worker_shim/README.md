# cyrene_worker_shim Directory Guide | sdk/python/cyrene_worker_shim 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `__init__.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `cyrene_worker.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `echo_worker.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `pyproject.toml` | Supporting metadata or fixture. | 辅助元数据或 fixture。 |
| `runner.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `test_runner.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `test_shim.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
