# src Directory Guide | sdk/python/cyrene_artifacts/src 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `cy_artifacts/` | Nested source or contract boundary; read its README next. | 嵌套源码或契约边界，下一步阅读其 README。 |
...
# sdk/python/cyrene_artifacts/src 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `cy_artifacts/` | 嵌套源码或契约边界，下一步阅读其 README。 |
