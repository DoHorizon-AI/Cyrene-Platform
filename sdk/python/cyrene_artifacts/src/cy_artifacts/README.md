# cy_artifacts Directory Guide | sdk/python/cyrene_artifacts/src/cy_artifacts 目录指南
...
| `local.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
...
# sdk/python/cyrene_artifacts/src/cy_artifacts 目录指南
