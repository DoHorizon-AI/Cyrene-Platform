# tests Directory Guide | sdk/python/cyrene_preflight/tests 目录指南
...
| `test_preflight.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
...
# sdk/python/cyrene_preflight/tests 目录指南
...
| `test_preflight.py` | Python SDK、TCK 或测试模块。 |
