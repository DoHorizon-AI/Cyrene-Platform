# cyrene_preflight Directory Guide | sdk/python/cyrene_preflight 目录指南
...
# sdk/python/cyrene_preflight 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `pyproject.toml` | 辅助元数据或 fixture。 |
| `src/` | 嵌套源码或契约边界，下一步阅读其 README。 |
| `tests/` | 嵌套源码或契约边界，下一步阅读其 README。 |
