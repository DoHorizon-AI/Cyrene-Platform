# cyrene_preflight Directory Guide | sdk/python/cyrene_preflight/src/cyrene_preflight 目录指南
...
| `contracts.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
| `reference.py` | Python SDK, TCK, or test module. | Python SDK、TCK 或测试模块。 |
...
# sdk/python/cyrene_preflight/src/cyrene_preflight 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `__init__.py` | Python SDK、TCK 或测试模块。 |
| `contracts.py` | Python SDK、TCK 或测试模块。 |
| `reference.py` | Python SDK、TCK 或测试模块。 |
