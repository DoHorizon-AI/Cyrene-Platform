...
This directory describes local development, branch flow, dependencies, and
verification expectations.

本目录说明本地开发、分支流程、依赖和验证要求。
...
| `ci.md` | CI checks and trust boundaries. | CI 检查与信任边界 |

## Suggested reading | 推荐顺序

Read `workspace-layout.md`, then `branch-model.md`, `dependencies.md`, and
