...
| **`media.processor.v1`** | Document text extraction & audio/image processing | `plugin/v1/plugin_protocol.proto` | Lifecycle Envelope | **EXPERIMENTAL** | Catalyst / Exchange | `plugins/tools/media` | **LEGACY_COMPATIBILITY_SHIM** |
...
| **`message.connector.v1`** | Instant messaging platform event connector | `plugin/v1/notification.proto` | Notification Payload | **EXPERIMENTAL** | Exchange / Navigator | `plugins/connectors/im` | **LEGACY_COMPATIBILITY_SHIM** |
