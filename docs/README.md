...
4. [`contracts/kernel-semantic-contract-v1.md`](contracts/kernel-semantic-contract-v1.md) — normative semantic authority.
5. [`flows/plugin-resolution-and-invocation.md`](flows/plugin-resolution-and-invocation.md) — a concrete execution path.
