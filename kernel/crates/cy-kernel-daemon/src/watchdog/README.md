# watchdog Directory Guide | kernel/crates/cy-kernel-daemon/src/watchdog 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `instance_actor.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `mod.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `supervisor.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# kernel/crates/cy-kernel-daemon/src/watchdog 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `instance_actor.rs` | Rust 实现、契约或测试文件。 |
| `mod.rs` | Rust 实现、契约或测试文件。 |
| `supervisor.rs` | Rust 实现、契约或测试文件。 |
