# adapter Directory Guide | kernel/crates/cy-kernel-daemon/src/adapter 目录指南
...
| Entry | Responsibility | 一句话职责 |
| --- | --- | --- |
| `events.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `mod.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
| `operations.rs` | Rust implementation, contract, or test file. | Rust 实现、契约或测试文件。 |
...
# kernel/crates/cy-kernel-daemon/src/adapter 目录指南
...
| 条目 | 职责 |
| --- | --- |
| `events.rs` | Rust 实现、契约或测试文件。 |
| `mod.rs` | Rust 实现、契约或测试文件。 |
| `operations.rs` | Rust 实现、契约或测试文件。 |
